...
var $author$project$ParseMain$GotFile = function (a) {
	return {$: 'GotFile', a: a};
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$ParseMain$requestParsing = _Platform_incomingPort('requestParsing', $elm$json$Json$Decode$string);
var $author$project$ParseMain$subscriptions = $author$project$ParseMain$requestParsing($author$project$ParseMain$GotFile);
...
var $author$project$Elm$Review$Vendor$Serialize$CustomTypeCodec = function (a) {
	return {$: 'CustomTypeCodec', a: a};
};
var $author$project$Elm$Review$Vendor$Serialize$customType = function (match) {
	return $author$project$Elm$Review$Vendor$Serialize$CustomTypeCodec(
		{
			idCounter: 0,
...
var $author$project$Elm$Review$AstCodec$InvalidChar = {$: 'InvalidChar'};
...
var $author$project$Elm$Review$Vendor$Serialize$Codec = function (a) {
	return {$: 'Codec', a: a};
};
var $author$project$Elm$Review$Vendor$Serialize$build = F2(
	function (jsonEncoder, jsonDecoder) {
		return $author$project$Elm$Review$Vendor$Serialize$Codec(
...
var $author$project$Elm$Review$AstCodec$char = A3(
	...
	function (string) {
		...
		if (_v0.b) {
			...
			return $elm$core$Result$Err($author$project$Elm$Review$AstCodec$InvalidChar);
		}
	},
	$elm$core$String$fromChar,
	$author$project$Elm$Review$Vendor$Serialize$string);
var $author$project$Elm$Review$Vendor$Serialize$RecordCodec = function (a) {
...
var $author$project$Elm$Review$Vendor$Serialize$field = F3(
	function (getter, codec, _v0) {
		...
		return $author$project$Elm$Review$Vendor$Serialize$RecordCodec(
			{
...
var $author$project$Elm$Review$Vendor$Serialize$DataCorrupted = {$: 'DataCorrupted'};
...
var $author$project$Elm$Review$AstCodec$infixDirection = A2(
	...
	$stil4m$elm_syntax$Elm$Syntax$Infix$Left,
	_List_fromArray(
		[$stil4m$elm_syntax$Elm$Syntax$Infix$Right, $stil4m$elm_syntax$Elm$Syntax$Infix$Non]));
...
var $author$project$Elm$Review$Vendor$Serialize$VariantEncoder = function (a) {
...
var $author$project$Elm$Review$Vendor$Serialize$variant = F3(
	function (matchJsonPiece, jsonDecoderPiece, _v0) {
		...
		var jsonEnc = function (v) {
			return $author$project$Elm$Review$Vendor$Serialize$VariantEncoder(
				_Utils_Tuple2(
					_Utils_Tuple0,
					A2(
						$elm$json$Json$Encode$list,
...
try {
	...
	throw 'Some top-level definitions from `Elm.Review.AstCodec` are causing infinite recursion:\n\n  ┌─────┐\n  │    pattern\n  │     ↓\n  │    lazyPattern\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
...
var $stil4m$elm_syntax$Elm$Syntax$Module$EffectModuleData = F4(
	function (moduleName, exposingList, command, subscription) {
		return {command: command, exposingList: exposingList, moduleName: moduleName, subscription: subscription};
	});
...
var $author$project$ParseMain$main = $elm$core$Platform$worker(
	{
		...
		subscriptions: $elm$core$Basics$always($author$project$ParseMain$subscriptions),
		update: F2(
			function (msg, _v0) {
				return _Utils_Tuple2(
					_Utils_Tuple0,
...
_Platform_export({'ParseMain':{'init':$author$project$ParseMain$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"ParseMain.Msg","aliases":{},"unions":{"ParseMain.Msg":{"args":[],"tags":{"GotFile":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));